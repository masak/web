...
{ # test_xmldecl
    ...
    is Hitomi::StreamEventKind::xml-decl, $kind;
    is '1.0', $version;
    ok !defined $encoding;
    is -1, $standalone;
}
...
{ # test_out_of_order_tags
    ...
    is 5, +@events;
    @events ||= [] xx 5;
    is [Hitomi::StreamEventKind::start, ['span', []]], @events[0][0,1];
    is [Hitomi::StreamEventKind::start, ['b',    []]], @events[1][0,1];
    is [Hitomi::StreamEventKind::text,  ['Foobar'  ]], @events[2][0,1];
    is [Hitomi::StreamEventKind::end,   ['b',      ]], @events[3][0,1];
    is [Hitomi::StreamEventKind::end,   ['span',   ]], @events[4][0,1];
}
...
{ # test_out_of_order_tags2
    ...
    is [Hitomi::StreamEventKind::start, ['span', Attrs.new(:class<baz>)]],
                                               @events[0][0,1];
    is [Hitomi::StreamEventKind::start, ['b',    []]], @events[1][0,1];
    is [Hitomi::StreamEventKind::start, ['i',    []]], @events[2][0,1];
    is [Hitomi::StreamEventKind::text,  ['Foobar'  ]], @events[3][0,1];
    is [Hitomi::StreamEventKind::end,   ['i',      ]], @events[4][0,1];
    is [Hitomi::StreamEventKind::end,   ['b',      ]], @events[5][0,1];
    is [Hitomi::StreamEventKind::end,   ['span',   ]], @events[6][0,1];
}
...
{ # test_hex_charref
    ...
    @events ||= [] xx 3;
    is [Hitomi::StreamEventKind::start, ['span', []]], @events[0][0,1];
    is [Hitomi::StreamEventKind::text,  ["'"       ]], @events[1][0,1];
    is [Hitomi::StreamEventKind::end,   ['span'    ]], @events[2][0,1];
}
